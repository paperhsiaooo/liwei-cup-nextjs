  ...
  const qaList = [
    {
      question: '什麼是「リキイ 盃」？',
      answer:
        '「力維盃」是一個想邀請身邊認識的球友們齊聚一堂的活動，不只是比賽，更是彼此交流、結識新朋友、一起享受打球樂趣的契機。希望讓每個參與的人，都能留下開心的回憶✨。<br /><br />「即使不像當年打得一樣好，但想和這些人再多打一下球」',
    },
    {
      question: '如何報名參加比賽？',
      answer:
    ...
    },
    {
      question: '比賽地點和時間？',
      answer:
        '比賽地點在「三米線僑中館」，詳細地址為「新北市板橋區僑中一街 124 巷 27-5 號」<br /><br />活動時間為 12:20~18:40。',
    },
    {
